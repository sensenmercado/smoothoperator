...
<?/*    <a href="drawpie.php" class="new_button"><img src="images/crystal/apps/blockdevice.png" width="96px" height="96px"><br />Number Statuses</a>*/?>
    ...
    <a href="report_agent_utilisation.php" class="new_button"><img src="images/crystal/apps/Volume%20Manager.png" width="96px" height="96px"><br />Agent Utilisation</a><br />
