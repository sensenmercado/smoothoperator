...
if ($_SESSION['user_level']<100) {
    ...
    <a href="dispositions.php" class="new_button"><img src="images/crystal/apps/download.png" width="96px" height="96px"><br />Dispositions</a><br />
<?/*    <a href="drawpie.php" class="new_button"><img src="images/crystal/apps/package_editors.png" width="96px" height="96px"><br />Script Results</a>
